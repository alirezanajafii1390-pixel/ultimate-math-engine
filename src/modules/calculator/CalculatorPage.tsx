...
export default function CalculatorPage() {
  ...
  const shareResult = useCallback(() => {
    ...
    const deepLink = buildAppDeepLink(encodeExprForStartParam(raw)) ?? buildAppBaseLink() ?? undefined;
  ...
  return (
    <div className="calc-in mx-auto flex h-full w-full max-w-xl flex-col overflow-hidden px-2.5 pb-3 pt-1.5 md:px-4 lg:max-w-3xl">
          ...
          <>
            <div className="mb-3 flex justify-end">
              <Btn
                ...
                onClick={() => {
                  haptics.destructive();
                  dispatch({ type: 'history:clear', kind: 'calculator' });
                }}
              >
                <Trash2 size={14} />
                {t('calc.clearAll')}
