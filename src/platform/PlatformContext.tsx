 ...
 *  from here on". */
class PlatformErrorBoundary extends Component<{ children: ReactNode }, { failed: boolean }> {
  state = { failed: false };
  ...
  render() {
    if (this.state.failed) {
      return <PlatformCtx.Provider value={webAdapter}>{this.props.children}</PlatformCtx.Provider>;
    }
